...
def Notification(msg='', title=HEADERMESSAGE, img=BACKGROUND, resize=False, L=0 ,T=0 ,W=1280 ,H=720 , TxtColor='0xFFFFFFFF', Font=FONTSETTINGS, BorderWidth=10):
...
def TestNotification(msg='', title=HEADERMESSAGE, img=BACKGROUND, resize=False, L=0 ,T=0 ,W=1280 ,H=720 , TxtColor='0xFFFFFFFF', Font=FONTSETTINGS, BorderWidth=10):
	class MyWindow(xbmcgui.WindowDialog):
		scr={};
		WINDOW=10147
		CONTROL_LABEL=1
