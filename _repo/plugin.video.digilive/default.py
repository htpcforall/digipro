...
addon = Addon('plugin.video.digilive', sys.argv)
...
if mode is None:
    ...
    addon.add_item({'mode': 'my_castaway'}, {'title':'My digiLive'}, img=icon_path('my_castaway.jpg'), fanart=fanart,is_folder=True)
    ...
    if str(answ)=='1':
        ...
        if path and name:
            ...
            if good:
                ...
                control.infoDialog('Cannot connect to list.',heading='digiLive Lists')
        else:
            control.infoDialog('A problem occured. Try again!',heading='digiLive Lists')
