...
class main():
	def __init__(self, url = 'http://stream-145310.appspot.com/arconaitv.me'):
		self.base = 'http://stream-145310.appspot.com'
	...
	def channels(self,index):
		...
		img = control.icon_path(info().icon)
		events = []
		html = client.request('http://stream-145310.appspot.com/arconaitv.me')
